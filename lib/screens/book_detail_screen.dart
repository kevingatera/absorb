            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (_rating!['numRatings'] != null &&
                      (_rating!['numRatings'] as num).toInt() > 0) ...[
                    const SizedBox(width: 4),
                    Text(
                      '(${_formatCount((_rating!['numRatings'] as num).toInt())})',
...
// ─── DOWNLOAD ACTION BUTTON (book detail page) ─────────────
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        final isDownloaded = dl.isDownloaded(itemId);
        final isDownloading = dl.isDownloading(itemId);
          ...
          child: isDownloading
              ? Stack(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () => dl.cancelDownload(itemId),
              ...
              : isDownloaded
                  ? IconButton.filledTonal(
                      icon: Icon(Icons.download_done_rounded, color: cs.primary),
                  ...
                  : IconButton.filledTonal(
                      ...
                      onPressed: () async {
                        if (api != null) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(duration: const Duration(seconds: 3), content: Text(
                              error ?? 'Downloading for offline play...')),
                          );
                        }
                      },
                    ),
